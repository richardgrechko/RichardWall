...
!(function (e) {
  ...
  function r() {
    var e = [
      ...
      "You cannot add more than 20 members.",
      "teal",
      "substring",
      ...
      "alt",
      "edge",
      "You have typed in your current username.",
      "isArray",
      "type 'confirm' here",
      "walldisablecolour",
      ...
      "push",
      "exportFont",
      "Copied link to current coordinates.",
      "ontouchstart",
      "getDate",
      "scrollTop",
      "enabled",
